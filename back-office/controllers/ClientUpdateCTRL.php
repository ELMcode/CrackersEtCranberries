<?php
// --- SQL paramétré : ClientUpdateCTRL.php
...
if ($btUpdate != NULL) {
    ...
    if ($idClient != null && $nomClient != null && $prenomClient != null && $adresseClient != null && $dateNaissanceClient != null && $cpClient != null && $emailClient != null && $mdpClient != null && $telephoneClient != null && $paysClient != null && $villeClient != null) {
        ...
        try {
            ...
            if ($affected === 1) {
                //$pdo->commit();
                $message = "Informations client modifiés avec succès !";

                header('Location: ../controllers/ClientUpdateCTRL.php');
                exit();
...
// "Retour" à l'IHM
include '../views/ClientUpdateIHM.php';