...
class Commande
{
    ...
    private float $montantTotalCommande;


    // Constructeur / Déclaration des méthodes

    public function __construct(int $idCommande = 0, int $idClient = 0, int $qteCommande = 0, string $dateCommande = "", string $statutCommande = "", float $montantTotalCommande = 0)
    {
    ...
    public function setMontantTotalCommande(float $montantTotalCommande): void
    {
        $this->montantTotalCommande = $montantTotalCommande;
    }
