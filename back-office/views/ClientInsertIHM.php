        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div>
                    ...
                    <div class="container">
                        <h4 class="mb-3">Insertion d'un client</h4>
                        <form action="../controllers/ClientInsertCTRL.php" method="post" id="formInsert">
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="paysClient" name="paysClient"
                                        placeholder="" value="" />
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="cpClient">Code postal :</label>
                                    <input type="number" class="form-control" id="cpClient" name="cpClient"
                                        placeholder="" value="" />
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="adresseClient" name="adresseClient"
                                        placeholder="XX, rue Crackers" value="" />
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date" class="form-control" id="dateNaissanceClient"
                                        name="dateNaissanceClient" placeholder="" value="" />
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="telephoneClient">Téléphone :</label>
                                    <input type="number" class="form-control" id="telephoneClient"
                                        name="telephoneClient" placeholder="" value="" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                            ...
                            <div>
                                <input type="submit" value="Ajouter le client" id="btInsert" name="btInsert"
