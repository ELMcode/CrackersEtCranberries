...
<body>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-end bg-white" id="sidebar-wrapper">
            <div class="sidebar-heading border-bottom bg-light">Ajouter un devis</div>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div>
                    ...
                    <div class="container">
                        <h4 class="mb-3">Insertion d'un devis</h4>
                        <form action="../controllers/DevisInsertCTRL.php" method="post" id="formInsert">
                            <div class="row">
                            ...
                            <div>
                                <input type="submit" value="Ajouter le devis" id="btInsert" name="btInsert"
