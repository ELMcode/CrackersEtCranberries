...
<body>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-end bg-white" id="sidebar-wrapper">
            <div class="sidebar-heading border-bottom bg-light">Supprimer un menu</div>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="container">
                    <h4 class="my-4">Liste de vos menus</h4>
                ...
                <div>
                    ...
                    <div class="container">
                        <h4 class="my-5">Suppression d'un menu</h4>
                        <form action="../controllers/MenuDeleteCTRL.php" method="post" id="formDelete">
                            <div class="row">
                                ...
                                <div>
                                    <input type="submit" value="Supprimer le menu" id="btDelete" name="btDelete"
