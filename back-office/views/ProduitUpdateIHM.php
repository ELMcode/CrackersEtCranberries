...
<body>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-end bg-white" id="sidebar-wrapper">
            <div class="sidebar-heading border-bottom bg-light">Modifier un produit</div>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div>
                    ...
                    <div class="container">
                        <h4 class="mb-3">Modification d'un produit</h4>
                        <form action="../controllers/ProduitUpdateCTRL.php" method="post" id="formUpdate">
                            <div class="row">
                            ...
                            <div>
                                <input type="submit" value="Ajouter le produit" id="btUpdate" name="btUpdate"
