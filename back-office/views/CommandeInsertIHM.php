...
<body>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-end bg-white" id="sidebar-wrapper">
            <div class="sidebar-heading border-bottom bg-light">Ajouter une commande</div>
        ...
        <div id="page-content-wrapper">
            ...
            <!-- Page content-->
            <div class="container-fluid">
                <!-- ! CommandeInsertIHM CONTENT !  -->
                <div class="container">
                    <h4 class="mb-3">Liste de vos commandes</h4>
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <?php foreach ($selectAll as $commande) { ?>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <?= $commande->getQteCommande() ?>
                                        </td>
                                        <td>
                                            <?= date('d/m/Y', strtotime($commande->getDateCommande())) ?>
                                        </td>
                                        <td>
                ...
                <div>
                    ...
                    <div class="container">
                        <h4 class="mb-3">Insertion d'une commande</h4>
                        <form action="../controllers/CommandeInsertPOOCTRL.php" method="post" id="formInsert">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="qteCommande">Quantité :</label>
                                    <input type="number" class="form-control" id="qteCommande" name="qteCommande"
                                        placeholder="" value="" />
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="statutCommande" name="statutCommande"
                                        placeholder="" value="" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="montantTotalCommande">Montant total :</label>
                                    <input type="number" class="form-control" id="montantTotalCommande"
                                        name="montantTotalCommande" placeholder="" value="" />
                                </div>
                            </div>
                            <div>
                                <input type="submit" value="Ajouter la commande" id="btInsert" name="btInsert"
