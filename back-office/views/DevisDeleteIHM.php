...
<body>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-end bg-white" id="sidebar-wrapper">
            <div class="sidebar-heading border-bottom bg-light">Supprimer un devis</div>
        ...
        <div id="page-content-wrapper">
            ...
            <!-- Page content-->
            <div class="container-fluid">
                <!-- ! DevisDeleteIHM CONTENT !  -->
                <div class="container">
                    <h4 class="my-4">Liste de vos devis</h4>
                ...
                <div>
                    ...
                    <div class="container">
                        <h4 class="my-5">Suppression d'un devis</h4>
                        <form action="../controllers/DevisDeleteCTRL.php" method="post" id="formDelete">
                            <div class="row">
                                ...
                                <div>
                                    <input type="submit" value="Supprimer le devis" id="btDelete" name="btDelete"
