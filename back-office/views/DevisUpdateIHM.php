...
<body>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-end bg-white" id="sidebar-wrapper">
            <div class="sidebar-heading border-bottom bg-light">Modifier un devis</div>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="container">
                    <h4 class="mb-3">Liste de vos devis</h4>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <?php foreach ($selectAll as $enregistrement) { ?>
                                    <tr>
                                        <td>
                                            <?= $enregistrement['id_devis'] ?>
                                        </td>
                                        <td>
                                            <?= $enregistrement['id_client'] ?>
                                        </td>
                                        <td>
                                            <?= $enregistrement['qte_devis'] ?>
                                        </td>
                                        <td>
                                            <?= date('d/m/Y', strtotime($enregistrement['date_devis'])) ?>
                                        </td>
                                        <td>
                                            <?= $enregistrement['montant_total_devis'] ?>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                ...
                <div>
                    ...
                    <div class="container">
                        <h4 class="mb-3">Modification d'un devis</h4>
                        <form action="../controllers/DevisUpdateCTRL.php" method="post" id="formUpdate">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="idDevis">ID du devis à modifier
                                        :</label>
                                    <input type="number" class="form-control" id="idDevis" name="idDevis" placeholder=""
                                        value="" />
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="idClient">ID du client (l'ID client doit être existant dans "clients")
                                        :</label>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="qteDevis">Quantité de devis :</label>
                                    <input type="number" class="form-control" id="qteDevis" name="qteDevis"
                                        placeholder="" size="4" step="any" value="" />
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="dateDevis">Date du devis :</label>
                                    <input type="date" class="form-control" id="dateDevis" name="dateDevis"
                                        placeholder="" size="4" value="3" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    <label for="montantTotalDevis">Montant total du devis (€) :</label>
                                    <input type="number" class="form-control" id="montantTotalDevis"
                                        name="montantTotalDevis" step="any" placeholder="" value="" />
                                </div>
                            </div>
                            <div>
                                <input type="submit" value="Modifier le devis" id="btUpdate" name="btUpdate"
